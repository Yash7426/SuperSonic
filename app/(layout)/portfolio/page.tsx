...
const Page = () => {
  ...
  const portfolioData = {
    ...
    swaps: [
      ...
      { fromToken: { name: "DOGECOIN", logo: "https://cryptologos.cc/logos/dogecoin-doge-logo.png", amount: 24672.32, value: 6338 }, toToken: { name: "BITCOIN", logo: "/images/bitcoin-logo.svg", amount: 0.064, value: 6338 }, date: "29 Jan 2025" }
    ]
  };
  return (
